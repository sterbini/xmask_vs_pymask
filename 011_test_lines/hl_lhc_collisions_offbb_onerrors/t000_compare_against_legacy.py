...
for sequence in ['lhcb1', 'lhcb2']:
    ...
    if sequence == 'lhcb1':
        lref = xt.Line.from_json('../../010_reference_lines/hl_lhc_collisions_offbb_onerrors_b1/'
                                 'xsuite_lines/line_bb_for_tracking.json')
    elif sequence == 'lhcb2':
        lref = xt.Line.from_json('../../010_reference_lines/hl_lhc_collisions_offbb_onerrors_b2/'
                                 'xsuite_lines/line_bb_for_tracking.json')
